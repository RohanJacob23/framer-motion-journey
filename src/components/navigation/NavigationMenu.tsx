            ...
            {activeIndex !== null && (
              ...
              >
                <motion.div
                  ...
                  className="radientBg relative w-max overflow-hidden rounded-lg border bg-gradient-to-b from-zinc-100 via-zinc-100 to-zinc-200 shadow-lg shadow-black/10 dark:from-zinc-900 dark:via-zinc-900 dark:to-zinc-800 dark:shadow-white/5"
                >
      ...
      <div className="grid grid-flow-row auto-rows-auto gap-2">
        ...
        <div>
          ...
          <p className="line-clamp-2 text-sm text-muted-foreground md:line-clamp-3">
            ...
            qui consectetur iste veritatis nesciunt ullam dolor deserunt
            excepturi quasi ea, odit maiores ab quam dicta officiis quia
            voluptates voluptatibus error?
          </p>
        </div>
      </div>
      <div className="grid grid-flow-row auto-rows-auto gap-2">
